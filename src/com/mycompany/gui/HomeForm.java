 ...
 tb.setTitleComponent(titleCmp);
      ...
      //  setLayout(BoxLayout.y());
       ...
       // Button btnListFac= new Button("List fac");
            //    Button btnaddFac= new Button("Add fac");

        Button Ajouterrec = new Button("Add reclamation");
        Label espace = new Label("");
  Label espace1 = new Label("");

          Ajouterrec.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent evt) {
                new AddreclamtionForm(res).show();
            }
        });
        ...
        add(Ajouterrec);
          ...
          btnListrec.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent evt) {
//                new affREc(res).show();
            }
