 ...
 * @author Asus
 */
public class ProfileFormSMBlog extends SideMenuBaseFormBlog {
    String username1;
    int id1;
    String img1;
    public ProfileFormSMBlog(Resources res) {
        super(BoxLayout.y());
        ...
        Container titleCmp = BoxLayout.encloseY(
                        ...
                        BorderLayout.west(
                                BoxLayout.encloseY(
                                    ...
                                    new Label("connected as ", "SubTitle")
                                )
                            ),
        ...
        addButtonBottom(arrowDown, "kamel", 0xd997f1, true);
